    ...
    execute: async function(bot, interaction) {
        ...
        await interaction.editReply({
            embeds: [
                ...
                .setDescription(`To link your account to the bot, use the following code in the game: \`${code}\``)
                .setColor("Green")
                .setTimestamp()
                .setFooter({
            ...
            if (repetitions >= 30) {
                ...
                await interaction.editReply({
                    embeds: [
                        ...
                        .setTitle("Link your account")
                        .setDescription("You have exceeded the maximum time to link your account")
                        .setColor("Red")
                        .setTimestamp()
                    ]
                })
            ...
            if(status.verified) {
                ...
                await interaction.editReply({
                    embeds: [
                        ...
                        .setTitle("Link your account")
                        .setDescription("Your account has been linked successfully to `" + status.username + "`")
                        .setColor("Green")
                        .setTimestamp()
                    ]
                })
